...
{
    public class NavbarCreateViewModel
    {
    ...
    public class NavbarCreateViewModelValidator : AbstractValidator<NavbarCreateViewModel>
    {
        public NavbarCreateViewModelValidator()
        {
            IntegrateRules();
        }
