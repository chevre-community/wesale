...
{
    public class AnnouncementUpdateApiModel
    {
        public AnnouncementUpdateApiModel()
        {
    ...
    public class AnnouncementUpdateApiModelValidator : AbstractValidator<AnnouncementUpdateApiModel>
    {
        ...
        public AnnouncementUpdateApiModelValidator(ITranslationService translationService)
        {
