...
namespace DataAccess.Migrations
{
    ...
    [Migration("20211124130046_announcementVideoUploadRequestAdded")]
    partial class announcementVideoUploadRequestAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Announcement.AnnouncementUpload.AnnouncementPhotoUploadRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AnnouncementPhotoUploadRequests");
                });

            modelBuilder.Entity("Core.Entities.Announcement.AnnouncementUpload.AnnouncementVideoUploadRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AnnouncementVideoUploadRequests");
                });
            ...
            modelBuilder.Entity("Core.Entities.Announcement.AnnouncementUpload.AnnouncementPhotoUploadRequest", b =>
                {
                    b.HasOne("Core.Entities.User", "User")
                        .WithMany("AnnouncementPhotoUploadRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Core.Entities.Announcement.AnnouncementUpload.AnnouncementVideoUploadRequest", b =>
                {
                    b.HasOne("Core.Entities.User", "User")
                        .WithMany("AnnouncementVideoUploadRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    b.Navigation("AnnouncementPhotoUploadRequests");

                    b.Navigation("Announcements");

                    b.Navigation("AnnouncementVideoUploadRequests");
